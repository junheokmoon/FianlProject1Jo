...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<c:url value="images/main1.png"/>" class="d-block w-100" alt="안나오냐 ㅅㅂ">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="images/main2.png"/>" class="d-block w-100" alt="안나오냐 ㅅㅂ">
    </div>
    <div class="carousel-item">
      <img src="<c:url value="images/main3.png"/>" class="d-block w-100" alt="안나오냐 ㅅㅂ">
    </div>
  </div>
