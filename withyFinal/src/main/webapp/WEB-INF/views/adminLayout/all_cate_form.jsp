...
<div class="boxed">
	<div id="content-container">
		<div id="page-title">
			<h1 class="page-header text-overflow"><strong>카테고리 관리</strong></h1>
		</div>
								...
								<table class="table table-striped table-hover" style="font-size: 15px; text-align: center;">
									<thead>
										<tr>
											...
											<th style="text-align: center;">이미지1</th>
											<th style="text-align: center;">이미지2</th>
											<th style="text-align: center;">수정</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											<td><a href="#" class="btn-link">N3</a></td>
											<td>넷플릭스</td>
											<td>3개월</td>
											<td>12,000원</td>
											<td>넷플이미지</td>
										...
										<tr>
											<td><a href="#" class="btn-link">D12</a></td>
											<td>디즈니</td>
											<td>12개월</td>
											<td>48,000원</td>
											<td>디즈니이미지</td>
