...
<!-- <div id="container" class="effect mainnav-lg">	 --><!-- 페이지 왼쪽 여백두게 설정 -->
	<div class="boxed">
		<div id="content-container">
			...
			<div id="page-title">
				<h1 class="page-header text-overflow"><strong>공지사항 수정</strong></h1>
			</div>
							...
							<form class="form-horizontal" style="font-size: 15px">
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control input-lg" id="ccccc" value="공지사항 입니다.">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3" for="ccccc" style="text-indent: 5em;">공지 내용</label>
										<div class="col-sm-6">
											<textarea rows="5" class="form-control">공지사항에 대한 내요오오오ㅗ오오오ㅗ오오오오ㅗㅇ옹</textarea>
										</div>
									</div>
								</div>
								<div class="text-right">
									<button class="btn btn-info btn-rounded" type="submit" style="font-size: 15px">완료</button>
									<button class="btn btn-info btn-rounded" type="button" onclick="location.href='all_notice.jsp'"style="font-size: 15px">목록</button>
								</div>
							</form>
						</div>
					</div>
